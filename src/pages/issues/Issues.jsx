...
import { Plus, Search, Download, FileDown, Package } from 'lucide-react';
        ...
        <Card>
          <CardBody>
            <div className="relative max-w-md">
              ...
              <Input placeholder="Search by code, batch, department…" className="pl-9" value={t.search} onChange={(e) => t.setSearch(e.target.value)} />
            </div>
          </CardBody>
        </Card>
      </motion.div>
